...
[OrderDate] [datetime] NOT NULL CONSTRAINT [DF__Order__OrderDate__25869641] DEFAULT (getdate()),
[OrderNumber] [nvarchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[CustomerId] [int] NOT NULL,
[TotalAmount] [decimal] (12, 2) NULL CONSTRAINT [DF__Order__TotalAmou__267ABA7A] DEFAULT ((0))
) ON [PRIMARY]
GO
